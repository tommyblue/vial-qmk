 ...
 * |------+------+------+------+------+------|           |------+------+------+------+------+------|
 * | ____ |  Caps|   ~  |MOUSE1|MOUSE2|MOUSE3|           |Reset |Btldr |      |   |  |   '  | ____ |
 * `-----------------------------------------'           `-----------------------------------------'
 *        ,------.         ,--------------------.    ,--------------------.          ,------.
 *        | ---- |         | LOWER|      |      |    |  Del |      | RAISE|          | ---- |
 *        `------'         `--------------------'    `--------------------.          `------'                     `--------------------'    `--------------------.
...
[_LOWER] = LAYOUT_split_3x6_3(
  ...
  _______,      _______, _______, KC_MS_BTN1, KC_MS_BTN2,  KC_MS_BTN3,      QK_RBT, QK_BOOT, _______, KC_PIPE,  KC_DQT, _______,
...
[_ADJUST] =  LAYOUT_split_3x6_3(
  KC_ESC,      RGB_TOG, RGB_RMOD, RGB_MOD, _______, _______,           KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,   _______,
